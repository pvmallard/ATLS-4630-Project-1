...
<h2>Milestone 4</h2>
<h3>Reflection</h3>
<p>Based on what I had planned for the result of my project, I'm fairly happy with where I ended up. There is a lot that is less than desireable, especially style-wise, but I achieved generally what I had hoped I would. I have a few GSAP implementations, templated css and layouts, and other features for each page, and I was able to make a fairly focused index page. I unfortunately wasn't able to complete any of my stretch goals, but they are things to keep in mind.</p>
<p>As for the critiques I received, I thought they were quite helpful, and things I can keep in mind moving forward. I should speed up the animations and would like to improve the css and stylization in the future. As for the info bubbles on the landing page,I had originally planned to make them clickable links, or things that would change the text upon hovering, but ran out of time. If I can't implement that I should remove the hover animations, but I love the thought bubbles idea! There is a lot I can still thing about...</p>
<h3>Moving Forward</h3>
<p>I'd like to implement these changes to my site, and use it as a temporary filler site for my job applications so at least employers have some information on me. However, this is still just a templated draft where I could experiment with animations. I want to redevelop this site using what I've learned about the GSAP and Locomotive libraries, but this time using React and Firebase. This will be more of an extended, personal project, however.</p>